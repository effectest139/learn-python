...
def example2():
    ...
    answer1 = r"ifTrue:\print('Hello,World!')"
    answer2 = r'ifTrue:\print("Hello,World!")'
...
def practice():
    ...
    print("문제:", end=' ')
    print("사용자로부터 'number'를 입력받고")
    print("number 값이 0보다 크면 '양수'를,")
    print("그렇지 않으면 '음수 또는 0'을 출력하는 코드를 작성하세요.")
    print("(줄바꿈은 ' \\ ' 기호를 사용하세요)")
    print()
    print("예시 출력:")
    print("양수")
    ...
    while True:
        ...
        if answer == target:
            ...
            if hint.lower() == "h":
                print()
                print("[힌트]")
                print("input()으로 입력받은 값은 문자열이므로 int()로 숫자로 바꿔주세요.")
                print("number = int(input('숫자를 입력하세요: ')) 형태로 작성하세요.")
                print("if number > 0: 과 else: 를 사용하여 양수/음수를 구분하세요.")
