...
STEPS = [
    ...
    },
    {
        ...
        "body": "코드:\nif True:\n    print('Hello, World!')\nelse:\n    print('Bye, World!')\n\n"
                ...
                "위 예제에서는 조건이 항상 참(True)이므로 'Hello, World!'가 출력되고 else 코드는 무시됩니다.",
    },
    {
        "type": "quiz",
        "title": "따라하기",
        ...
        "hint": "조건문은 True로 작성하고, print() 안에 'Hello, World!'를 넣어보세요.",
        "exp": 5,
    },
    {
        "type": "quiz",
        ...
        "prompt": "사용자로부터 'number'를 입력받고\n"
                  "number 값이 0보다 크면 '양수'를, 그렇지 않으면 '음수 또는 0'을 출력하는 코드를 작성하세요.\n"
                  "(줄바꿈은 ' \\ ' 기호를 사용하세요)\n\n"
                  "예시 출력: 양수",
        "answers": [
